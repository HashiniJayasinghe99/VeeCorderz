...
public class Sub_QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(selectedOptionByUser.isEmpty()){
                    Toast.makeText(Sub_QuizActivity.this, "please select an option", Toast.LENGTH_SHORT).show();
                }
                else{
                    changeNextQuestion();
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(Sub_QuizActivity.this, MainActivity.class));
                finish();
            }
        });
    ...
    private void changeNextQuestion() {
        ...
        if(currentQuestionPosition < questionLists.size()){
            ...
            Intent intent = new Intent(Sub_QuizActivity.this, QuizResults.class);
        ...
        quizTimer.scheduleAtFixedRate(new TimerTask() {
            ...
            public void run() {
                if(seconds == 0){
                    ...
                    Toast.makeText( Sub_QuizActivity.this,"Time Over", Toast.LENGTH_LONG).show();
